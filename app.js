...
function renderStatistics() {
  ...
  <details class="game-guide"><summary>Номинации и достижения — все правила</summary><table><tr><th>Награда</th><th>За что</th><th>Тип</th></tr><tr><td>Укротитель коров</td><td>Лучшее среднее при 3+ играх</td><td>Меняется</td></tr><tr><td>Коровий магнит</td><td>Самое высокое среднее</td><td>Меняется</td></tr><tr><td>Железное копыто</td><td>Больше всего партий</td><td>Меняется</td></tr><tr><td>Победный галоп</td><td>Лучшая серия побед</td><td>Меняется</td></tr><tr><td>Коровьи горки</td><td>Самые переменчивые результаты</td><td>Меняется</td></tr><tr><td>Первая победа</td><td>Первая выигранная партия</td><td>Навсегда</td></tr><tr><td>Чистые копыта</td><td>Итог 10 или меньше</td><td>Навсегда</td></tr><tr><td>Ветеран стада</td><td>25 партий</td><td>Навсегда</td></tr></table></details><details class="stats-help"><summary>Что означают показатели?</summary><dl><div><dt>Среднее</dt><dd>Средний итоговый штрафной счёт за партию. Чем меньше, тем лучше.</dd></div><div><dt>Рекорд</dt><dd>Самый низкий итоговый счёт игрока за выбранный период.</dd></div><div><dt>Серия</dt><dd>Победы подряд сейчас; в скобках — лучшая серия за период.</dd></div><div><dt>Динамика</dt><dd>Последние результаты слева направо. Низкий столбик лучше высокого.</dd></div></dl></details></section>`;
}
